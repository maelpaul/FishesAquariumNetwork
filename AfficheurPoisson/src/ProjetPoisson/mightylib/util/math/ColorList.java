package ProjetPoisson.mightylib.util.math;

public class ColorList {
    public static final Color4f WHITE = new Color4f(1.0f, 1.0f, 1.0f, 1.0f);
    public static final Color4f LIGHT_GREY = new Color4f(0.75f, 0.75f, 0.75f, 1.0f);
    public static final Color4f GREY = new Color4f(0.5f, 0.5f, 0.5f, 1.0f);
    public static final Color4f DARK_GREY = new Color4f(0.25f, 0.25f, 0.25f, 1.0f);
    ...
    public static final Color4f ORANGE = new Color4f(1.0f, 0.5843f, 0.0f, 1.0f);
}
